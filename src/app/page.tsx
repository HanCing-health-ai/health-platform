        ...
        <form onSubmit={handleSubmit} className="px-8 py-8 space-y-10">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ml-10">
              ...
              <div>
                <label className="block text-sm font-medium text-slate-700 mb-1">聯絡電話 (用來綁定紀錄) <span className="text-red-500">*必填</span></label>
                <input required pattern="^09\d{8}$" title="請輸入有效的手機號碼，例如：0912345678" type="tel" value={phone} onChange={e => setPhone(e.target.value)} className="w-full rounded-lg border-slate-200 border-2 p-3 focus:border-indigo-500 focus:ring-0" placeholder="0912345678" />
              </div>
            </div>
          </section>
